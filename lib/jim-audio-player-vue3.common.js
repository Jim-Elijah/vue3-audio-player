...
const _hoisted_3 = /*#__PURE__*/(0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createTextVNode)(" 您的浏览器不支持音频播放 ");

function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createElementBlock)("div", _hoisted_1, [(0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createElementVNode)("audio", {
  ...
  }, [(0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createElementVNode)("source", {
    src: $props.src
  }, null, 8, _hoisted_2), _hoisted_3], 544), (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.renderSlot)(_ctx.$slots, "default", {
...
;// CONCATENATED MODULE: ./packages/vue3-audio-player/src/index.vue?vue&type=template&id=2c93cefa

;// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-40.use[1]!./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./packages/vue3-audio-player/src/index.vue?vue&type=script&lang=js
...
;// CONCATENATED MODULE: ./packages/vue3-audio-player/src/index.vue?vue&type=script&lang=js
 
// EXTERNAL MODULE: ./node_modules/vue-loader/dist/exportHelper.js
var exportHelper = __webpack_require__(744);
;// CONCATENATED MODULE: ./packages/vue3-audio-player/src/index.vue
...
/* harmony default export */ var vue3_audio_player_src = (__exports__);
;// CONCATENATED MODULE: ./packages/vue3-audio-player/index.js
// src/index.js
// 导入组件，组件必须声明 name
 // 为组件提供 install 安装方法，供按需引入

vue3_audio_player_src.install = function (Vue) {
  Vue.component(vue3_audio_player_src.name, vue3_audio_player_src);
}; // 默认导出组件


/* harmony default export */ var vue3_audio_player = (vue3_audio_player_src);
;// CONCATENATED MODULE: ./packages/index.js
// 导入组件
 // 存储组件列表

const components = [vue3_audio_player]; // 定义 install 方法，接收 Vue 作为参数。如果使用 use 注册插件，则所有的组件都将被注册
...
/* harmony default export */ var packages_0 = ({
  ...
  install,
  // 以下是具体的组件列表
  Vue3AudioPlayer: vue3_audio_player
});
...
/******/ })()
;
//# sourceMappingURL=jim-audio-player-vue3.common.js.map